...
class Barcode {
    ...
    public static function digitToFPDFRenderer($pdf, $color, $xi, $yi, $angle, $mw, $mh, $digit){
        if (!is_array($color)){
    ...
    static public function result($xi, $yi, $columns, $lines, $mw, $mh, $cos, $sin){
    ...
    static public function _rotate($x1, $y1, $cos, $sin , &$x, &$y){
        $x = $x1 * $cos - $y1 * $sin;
        $y = $x1 * $sin + $y1 * $cos;
    }
